...
<script type="text/javascript">
   ...
   function insert_form(ca_idx){
	   ...
	   //글쓰기 폼으로 이동:
	   location.href="board_insert_form.do?ca_idx="+ca_idx
   ...
   function search(){
	   ...
	   location.href="board_list.do?ca_idx="+ca_idx+"&search=" + search + "&search_text=" + encodeURIComponent(search_text);
...
<body>
  <div id="box">
       <h3>${param.ca_name}개시판 입니다.</h3>
       <input id="ca_idx" type="hidden" value="${ param.ca_idx }">
       
       <div style="margin-bottom: 10px;">
           <input  class="btn"  type="button"  value="글쓰기"  
                   onclick="insert_form(${param.ca_idx});">
       </div>
                ...
                <tr>
                    ...
                    <td style="text-align: left; text-indent: 10px;">
                         ...
                         <c:if test="${ vo.b_use_yn eq 'y' }">
                         	 <a href="board_view.do?b_idx=${ vo.b_idx }">
                         	 ${ vo.b_title }
                         	 </a>
    					 ...
    					 <c:if test="${ vo.b_use_yn eq 'n' }">
    					 	<font color="pink">(삭제된 게시물) ${ vo.b_title }</font>
    					 </c:if>
